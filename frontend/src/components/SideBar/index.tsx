                            ...
                            {groups.map((g) => {
                                ...
                                return (
                                    <div
                                        ...
                                        onClick={() => {
                                            onSelectChat(g._id);
                                            // Dispatch event để refresh latest messages
                                            setTimeout(() => {
                                                window.dispatchEvent(new CustomEvent('chatSelected'));
                                            }, 100);
                                        }}
                                        className={`p-3.5 rounded-2xl cursor-pointer transition-all duration-300 group ${isSelected
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <p className={`font-semibold text-sm truncate transition-all ${isSelected ? "text-white" : ""
                                                    }`}>{g.name}</p>
                                                <p
